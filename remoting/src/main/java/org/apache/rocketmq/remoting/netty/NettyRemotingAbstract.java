...
public abstract class NettyRemotingAbstract {
     ...
     * </p>
     *
     * @see NettyRemotingClient 的timer 变量会触发该方法 或 @see NettyRemotingServer的timer定时
     */
    ...
    public RemotingCommand invokeSyncImpl(final Channel channel, final RemotingCommand request,
        ...
        try {
            /**
             * ResponseFuture为异步转同步的关键及responseTable
             */
     ...
     * @see NettyRemotingAbstract processMessageReceived 方法及 scanResponseTable 的定时任务
     */
