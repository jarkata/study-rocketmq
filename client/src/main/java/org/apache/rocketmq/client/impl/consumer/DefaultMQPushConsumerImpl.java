...
public class DefaultMQPushConsumerImpl implements MQConsumerInner {
    ...
    /**
     * 在PullMessageService方法中会调用该方法拉取消息
     *
     * @param pullRequest
     * @see PullMessageService
     */
    public void pullMessage(final PullRequest pullRequest) {
        ...
        /**
         * 判断本地缓存的消息数是否超过每个队列拉取消息的阀值，如果超过了，会输出警告日志，并延后50ms执行
         */
        ...
        /**
         * 判断本地缓存消息的大小是否超过每个队列拉取消息大小的阀值，超过之后，延后50ms执行
         */
        ...
        PullCallback pullCallback = new PullCallback() {
            ...
            public void onSuccess(PullResult pullResult) {
                if (pullResult != null) {
                    /**
                     * 处理了拉取的结果，并对消息做一次tag过滤
                     */
                    pullResult = pullAPIWrapper.processPullResult(pullRequest.getMessageQueue(), pullResult,
                            subscriptionData);
    ...
    /**
     * 执行拉取消息的请求,该操作将拉取消息的请求对象写入客户端内存
     *
     * @param pullRequest
     */
    ...
    public synchronized void start() throws MQClientException {
        switch (this.serviceState) {
            case CREATE_JUST:
                ...
                /**
                 * MQ客户端工厂类注册消费者，在本地缓存中注册，注册消费组与消费者对象之间到关系
                 */
